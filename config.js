...
const CONFIG = { // 主配置对象，包含网站所有配置项
    ...
    // ====================================
    site: { // 网站基础信息配置
        title: "砚禾 - 燕云十六声百业搜索", // 网站标题，显示在浏览器标签页
        description: "砚禾致力于展示各流派咸鱼人生的风采。" // 网站描述，用于SEO优化
    },
    ...
    hero: { // 首页区域配置
        ...
        title: "砚禾", // 首页主标题文字
        // 首页副标题
        subtitle: "砚墨挥毫书侠义，禾丰谷满聚英豪。燕云寻侠同闯荡，共赴江湖万里涛。", // 首页副标题描述文字
        // 首页背景
        background: { // 首页背景媒体配置对象
            url: "https://file.icve.com.cn/file_doc/qdqqd/7861773156146292.avif", // 背景媒体文件URL地址
        ...
        // 首页遮罩层
        overlay: "linear-gradient(135deg, rgba(26, 32, 44, 0.7) 0%, rgba(141, 54, 212, 0.3) 0%, rgba(74, 85, 104, 0.3) 0%)", // 首页背景遮罩层渐变效果，rgba最后一位数是透明度，前三位数是颜色数据，具体看gitee常用命令上方的基础颜色
        // 首页按钮配置
        buttons: { // 首页按钮样式配置
            primary: { // 主要按钮样式
    ...
    about: { // 关于我们区域配置
        ...
        subtitle2: "砚禾", // 关于我们区域副标题2
        background: "#1A202C", // 关于我们区域背景色
        content: { // 关于我们区域内容配置
            text1: [ // 第一个文本区域内容数组
                "砚禾致力于展示各流派咸鱼人生的风采。", // 第一段文字内容
    ...
    footer: { // 页脚区域配置
        ...
        sections: [ // 页脚内容区块数组
            ...
            { // 第三个页脚区块
                title: "关注我们", // 区块标题
                social: [ // 社交媒体链接数组
                    { platform: "抖音", account: "砚禾" } // 社交平台信息对象
                ]
            }
        ],
        copyright: "&copy; 2025 砚禾. 保留所有权利." // 版权信息文字
    },
